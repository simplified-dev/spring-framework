...
public class ServerWebConfig implements WebMvcConfigurer {
     ...
     * The framework's {@link dev.simplified.serverapi.error.ErrorController RestControllerAdvice}
    ...
    /**
     * Shared response writer used by {@link dev.simplified.serverapi.error.ErrorController} and
